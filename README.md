...
-- | -- | -- | --
13 Jul | Course introduction | [Lab session to get software setup](labs/week-01) | [Open science, open source, and doing GIS in code](https://southosullivan.com/geog315/slides/open/)
20 Jul | [Starting *R*](https://southosullivan.com/geog315/slides/starting-r/) | [Introducing *R* and *RStudio*](labs/week-02) | [The myth of tidy data](https://southosullivan.com/geog315/slides/tidy-data/)
27 Jul | [Choropleth map design](https://southosullivan.com/geog315/slides/choropleth-maps/) | [**Making maps**](labs/week-03) (15%) due 10 Aug | [Data wrangling](https://southosullivan.com/geog315/slides/data-munging/)
3 Aug | [Spatial data wrangling](https://southosullivan.com/geog315/slides/spatial-data-munging/) | [**Spatial data manipulation**](labs/week-04) (15%) due 31 Aug | [Spatial data wrangling (continued)](https://southosullivan.com/geog315/slides/spatial-data-munging/)<br />and [handling tables](https://southosullivan.com/geog315/slides/table-joins-and-dissolves/)
10 Aug | [Clustering analysis](https://southosullivan.com/geog315/slides/classification-clustering/) | [**Geographic cluster analysis**](labs/week-05) (20%) due 10 Sep | [Applications of clustering analysis](https://southosullivan.com/geog315/slides/classification-examples/)
&nbsp; | &nbsp; | **BREAK** | &nbsp;
31 Aug | [Statistics and geography](https://southosullivan.com/geog315/slides/statistics-and-space/) | Help with assignments | [From overlay to regression models](https://southosullivan.com/geog315/slides/from-overlay-to-regression/)
7 Sep | [Regression models](https://southosullivan.com/geog315/slides/regression/) |  [**Building a simple statistical model**](labs/week-07) (20%) due 21 Sep | [More on regression](https://southosullivan.com/geog315/slides/more-on-regression/)
14 Sep | [Other spatial analysis methods](https://southosullivan.com/geog315/slides/spatial-analysis-methods/) | Help with assignments | [Surface analysis](https://southosullivan.com/geog315/slides/surface-analysis/)
21 Sep | Project topics overview and [Running a GIS project](https://southosullivan.com/geog315/slides/running-a-gis-project/) | [**Introducing the mini-projects**](labs/mini-project) (30%) due 16 Oct | [Network analysis](https://southosullivan.com/geog315/slides/network-analysis/)
28 Sep | [Time geography](https://southosullivan.com/geog315/slides/time-geography/) | Project support / guest
5 Oct | [Simulation models](https://southosullivan.com/geog315/slides/simulation-models/) | Project work | Project support (in KK217)
