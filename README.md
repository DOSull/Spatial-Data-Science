...
&nbsp; | &nbsp; | BREAK | &nbsp; | &nbsp; | &nbsp;
2 Sep | Running a GIS project revisited | Surface analysis | Lab time: project work |
9 Sep | Guest lecture (Daniel Silk, LINZ) | Network analysis | Lab time: project work |
