...
This is an implementation of a simple two dimensional voter model, optionally with spatially ordered (sequential) update of site states.

This model is discussed in Chapter 3 of

+   O'Sullivan D and Perry GLW 2013 _Spatial Simulation: Exploring Pattern and Process_. Wiley, Chichester, England.

You should consult Chapter 3 of that book for more information and details of the model.
...
Try allowing more initial states in the model.  At least one practical issue makes this harder than it sounds, if you care about being able to _watch_ a model.
