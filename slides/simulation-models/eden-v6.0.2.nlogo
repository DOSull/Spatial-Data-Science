...
to go
  ...
  ask one-of perimeter-set [
    set occupied? true
    set pcolor scale-color red ticks (N * 0.628) 0
    let new-edge-cells neighbors4 with [not occupied?]
    set at-edge? any? new-edge-cells with [edge?]
...
This model simulates the class Eden growth process:
...
as discussed in Chapter 5 of 

+   O'Sullivan D and Perry GLW 2013 _Spatial Simulation: Exploring Pattern and Process_. Wiley, Chichester, England.

A noise-reduced variant, as discussed in 
