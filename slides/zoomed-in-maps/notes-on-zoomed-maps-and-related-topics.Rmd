...
## Other basemaps
Other basemaps are available than OpenStreetMap. You can see the options in the `get_tiles()` function help. For example, this is a nice one (if a bit distracting). Here's a nice one:
...
Some providers supply labelled and unlabelled versions, so you can do this kind of thing:
