...
+ What are appropriate data to map. Probably none of the supplied attributes is quite what you need to make an effective map, so you will need to add one or more new attributes (this was explained [here](making-maps-in-R-selecting-and-tidying-data.md#adding-new-attributes))
