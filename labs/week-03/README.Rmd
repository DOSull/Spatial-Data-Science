...
## Videos
Videos supporting each section are linked below. These use a different data set to demonstrate some of the ideas. You can download that dataset [here](ak-region-ethnicity.gpkg?raw=true), if you'd like to try following along. The video 'cuts' might overlap a little. The more important videos for completing the assignment are indicated by a ** symbol.
