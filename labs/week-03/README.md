...
A preview of the results you can expect to see from this session is available [here](https://southosullivan.com/geog315/labs/introducing-r-and-rstudio.html).
