...
-- | -- | -- | --
5 Jul | Course introduction<br>[Example script](scripts/covid-demo.R) | [Lab session to get software setup](labs/week-01) | [Open science, open source, and doing GIS in code](https://southosullivan.com/geog315/open/)
